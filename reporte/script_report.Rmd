...
author: "Daniel Aromí^[aromi.daniel@gmail.com], Paula Bonel^[mpaulabonel@gmail.com], Llada Martin^[lladamartin@gmail.com]"
date:  "November, 2024"
output:
  #pdf_document:
  #  toc: yes
...
knitr::opts_knit$set(root.dir = "G:/.shortcut-targets-by-id/1VQsWu8tFyWkeO3ASvXq3GAtC-ARb18dM/ecc_base")
```
